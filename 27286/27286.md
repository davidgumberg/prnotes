...
```python
        ...
        #   import where the block advances.I should look at how mtp time works,
...
index e1ebcbe71e1c3..3e40714ae145c 100644
...
diff --git a/src/wallet/wallet.cpp b/src/wallet/wallet.cpp
index cc604ed27986a..b133753de944e 100644
--- a/src/wallet/wallet.cpp
+++ b/src/wallet/wallet.cpp
@@ -1122,6 +1122,9 @@ CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const TxState& state, const
...
@@ -1185,6 +1188,8 @@ bool CWallet::LoadToWallet(const Txid& hash, const UpdateWalletTxFn& fill_wtx)
...
@@ -2348,6 +2353,9 @@ util::Result<void> CWallet::RemoveTxs(WalletBatch& batch, std::vector<Txid>& txs
...
@@ -4470,4 +4478,22 @@ void CWallet::WriteBestBlock() const
...
index fbc3bed2ab677..2845b5450db0f 100644
...
@@ -510,6 +513,9 @@ class CWallet final : public WalletStorage, public interfaces::Chain::Notificati
